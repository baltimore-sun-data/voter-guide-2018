  ...
  $.getJSON(feed, function(data) {
    ...
    $.each(data, function(index, key) {
      if ((key.raceid == raceID) & (key.fipscode == null)) {
        ...
        html.push(
          '<table class="candidate-row"><tr><td class="candidate name "> ',
          key.first,
          " ",
          key.last,
          '</td><td class="party-col">',
          key.party,
          '</td><td class="votes">',
          votecount.toLocaleString("en"),
          '</td><td class="percent"><div class="percent-bar-bg"><div class="percent-bar" style="width:',
          percent,
          '%;"></div></div><div class="vote-percent">',
          percent,
          "%</div></td></tr></table>"
        );
    ...
    $.getJSON(
      "http://data.baltimoresun.com/news/elections2016/json/jsonPrecincts.json",
      function(data) {
        var html3 = [];
