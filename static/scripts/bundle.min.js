!(function(e, t) {
  ...
  return (function(e) {
                ...
                value: function(e) {
                  return new Promise(
                    function(t, n) {
                      ...
                      return (
                        (r = e.query),
                        (o = ~location.protocol.indexOf("http")
                          ? location.protocol
                          : "https:"),
                        (i = this.endpoint({ query: r, protocol: o })),
                        fetch(i).then(
                          function(e) {
                            return (
                              (a = e),
                              a.json().then(
                                function(e) {
                                  return (u = e), t(this.parse({ data: u }));
                                }.$asyncbind(this, n),
                                n
                              )
                            );
    ...
    function(e, t, n) {
            ...
            function o(t, n) {
              ...
              try {
                if (((a = t.call(i, n)), a.done)) {
                  if (a.value !== e) {
                    if (a.value && a.value === a.value.then)
                      return a.value(e, r);
                    e && e(a.value), (e = null);
                  }
                  return;
      ...
      var i = r({ zousan: "" + n(16), thenable: "" + n(15) }, function e(t, n) {
        function r() {
        ...
        Function.prototype.$asyncbind ||
          ...
          e.trampoline ||
            (e.trampoline = function(e, t, n, r, o) {
              return function i(a) {
                for (; a; ) {
      ...
      i(), o(), (e.exports = { $asyncbind: i, $asyncspawn: o });
    },
    function(e, t) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 });
        ...
        c = (function() {
          function e() {
            var t = this,
              ...
              l = void 0 === c ? {} : c;
            o(this, e);
            var f = (0, u.createElement)(
                "div",
                ["geosearch", l.container].join(" ")
              ),
            ...
            (d.type = "text"),
              ...
              (this.elements = { container: f, form: p, input: d }),
              (this.handleSubmit = i);
          }
          return (
            a(e, [
                  ...
                  return new Promise(
                    function(t, n) {
                      ...
                      return (
                        ...
                        (o = r.input),
                        (i = r.container),
                        (0, u.removeClassName)(i, "error"),
                        (0, u.addClassName)(i, "pending"),
                        this.handleSubmit({ query: o.value }).then(
                          function(e) {
              ...
              },
              {
                ...
                value: function() {
                  ...
                  this.hasError &&
                    ((0, u.removeClassName)(e, "error"), (this.hasError = !1));
                }
              },
              {
                key: "onKeyUp",
                value: function(e) {
                  var t = this.elements,
                    n = t.container,
                    r = t.input;
                  e.keyCode === s.ESCAPE_KEY &&
                    ((0, u.removeClassName)(n, "pending"),
                    (0, u.removeClassName)(n, "active"),
                    (r.value = ""),
                    document.body.focus(),
                    document.body.blur());
                }
      ...
      var u = n(14),
        ...
        v = function() {
          return {
            ...
            marker: { icon: new L.Icon.Default(), draggable: !1 },
            maxMarkers: 1,
            retainZoomLevel: !1,
            animateZoom: !0,
        ...
        b = {
          initialize: function(e) {
            ...
            "button" !== r &&
              (this.options.classNames.container += " " + e.style),
              (this.searchElement = new l.default(
                a({}, this.options, {
            ...
            (g.innerHTML = "X"),
              ...
              u &&
                ((this.resultList = new p.default({
                  handleClick: function(e) {
                    var n = e.result;
                    (y.value = n.label), t.onSubmit({ query: n.label });
                  }
                })),
                m.appendChild(this.resultList.elements.container),
                y.addEventListener(
                  "keyup",
              ...
              (this.elements = { button: b, resetButton: g });
          },
          onAdd: function(e) {
            var t = this.options,
              n = t.showMarker,
          ...
          onClick: function(e) {
            ...
            n.classList.contains("active")
              ? ((0, d.removeClassName)(n, "active"), this.clearResults())
              : ((0, d.addClassName)(n, "active"), r.focus());
          },
          ...
          selectResult: function(e) {
            if (
              [h.ENTER_KEY, h.ARROW_DOWN_KEY, h.ARROW_UP_KEY].includes(
                e.keyCode
              )
            ) {
              e.preventDefault();
              ...
              if (e.keyCode === h.ENTER_KEY)
                return void this.onSubmit({ query: t.value });
          ...
          clearResults: function(e) {
            ...
            if (!e || e.keyCode === h.ESCAPE_KEY) {
              var n = this.searchElement.elements.input,
                ...
                o = r.keepResult,
                i = r.autoComplete;
              (!t && o) || ((n.value = ""), this.markers.clearLayers()),
                i && this.resultList.clear();
            }
          },
          autoSearch: function(e) {
            return new Promise(
              function(t, n) {
                ...
                var o, i, a;
                return h.SPECIAL_KEYS.includes(e.keyCode)
                  ? t()
                  : ((o = e.target.value),
                    (i = this.options.provider),
                    o.length
                      ? i.search({ query: o }).then(
                          function(e) {
                            return (
                              (a = e), this.resultList.render(a), r.call(this)
                            );
                          }.$asyncbind(this, n),
                          n
                        )
                      : (this.resultList.clear(), r.call(this)));
              }.$asyncbind(this)
            );
          },
          onSubmit: function(e) {
            return new Promise(
              function(t, n) {
                var r, o;
                return (
                  (r = this.options.provider),
                  r.search(e).then(
                    function(n) {
                      return (
                        (o = n),
                        o && o.length > 0 && this.showResult(o[0], e),
                        t()
                      );
                    }.$asyncbind(this, n),
                    n
          ...
          showResult: function(e, t) {
            ...
            this.options.maxMarkers > o.length ||
              this.markers.removeLayer(o[0]);
          ...
          addMarker: function(e, t) {
            var n = this,
              ...
              s = e.label;
            return (
              "function" == typeof a && (s = a({ query: t, result: e })),
              u.bindPopup(s),
              this.markers.addLayer(u),
              i && u.openPopup(),
              o.draggable &&
                u.on("dragend", function(e) {
          ...
          centerMap: function(e) {
            ...
            !n && o.isValid()
              ? this.map.fitBounds(i, { animate: r })
              : this.map.setView(i.getCenter(), this.getZoom(), { animate: r });
          },
          getZoom: function() {
            var e = this.options,
              t = e.retainZoomLevel,
            ...
            c(t, [
              {
                ...
                value: function() {
                  var e =
                    ...
                    i = this.getParamString(s({}, o, { query: t, jsonp: r }));
              ...
              },
              {
                ...
                value: function(e) {
                  var t = e.data;
                  return 0 === t.resourceSets.length
                    ? []
                    : t.resourceSets[0].resources.map(function(e) {
                        return {
                  ...
                  return new Promise(
                    function(t, n) {
                      ...
                      return (
                        ...
                        (0, p.createScriptElement)(a, i).then(
                          function(e) {
                            return (u = e), t(this.parse({ data: u }));
                          }.$asyncbind(this, n),
                          n
            ...
            s(t, [
              {
                ...
                value: function() {
                  var e =
                    ...
                    o = this.getParamString(u({}, r, { f: "json", text: t }));
                  return (
                    n +
            ...
            s(t, [
              {
                ...
                value: function() {
                  var e =
                    ...
                    n = e.protocol,
                    r = this.options.params,
                    o = this.getParamString(u({}, r, { format: "json", q: t }));
                ...
                value: function(e) {
                  ...
                  return t.map(function(e) {
                    return {
                      ...
                      bounds: [
                        [
                          parseFloat(e.boundingbox[0]),
                          parseFloat(e.boundingbox[2])
                        ],
                        [
                          parseFloat(e.boundingbox[1]),
                          parseFloat(e.boundingbox[3])
                        ]
                      ],
                      raw: e
                    };
      ...
      var o = (function() {
        ...
        u = (function() {
          function e() {
            ...
            r(this, e),
              s.call(this),
              (this.props = { handleClick: o, classNames: c }),
              (this.selected = -1);
            var l = (0, i.createElement)("div", a("results", c.container)),
              f = (0, i.createElement)("div", a(c.item));
            l.addEventListener("click", this.onClick, !0),
              (this.elements = { container: l, resultItem: f });
          }
          return (
            o(e, [
              {
                ...
                value: function() {
                  ...
                  this.clear(),
                    ...
                    e.length > 0 && (0, i.addClassName)(n, "active"),
                    (this.results = e);
                }
              },
              {
                ...
                value: function(e) {
                  ...
                  return (
                    Array.from(t.children).forEach(function(t, n) {
                      return n === e
                        ? (0, i.addClassName)(t, "active")
                        : (0, i.removeClassName)(t, "active");
                    }),
                    (this.selected = e),
                    this.results[e]
                  );
              ...
              },
              {
                ...
                value: function() {
                  var e = this.elements.container;
                  for (this.selected = -1; e.lastChild; )
    ...
    function(e, t) {
      e.exports = function() {
        ...
        return (
          (n.prototype = { resolve: r, reject: r, then: o }),
          (a.resolve = function(e) {
            return a.isThenable(e)
              ? e
              : {
                  then: function(t) {
                    return t(e);
              ...
              resolve: function(e) {
                if (void 0 === this.state) {
                  ...
                  (this.state = o),
                    ...
                    t.c &&
                      a(function() {
                        for (var n = 0, r = t.c.length; r > n; n++)
                          o(t.c[n], e);
                      });
                }
              },
      ...
      (function(e, t) {
        !(function(e, n) {
          ...
          function r(e) {
            ...
            for (var t = Array(arguments.length - 1), n = 0; t.length > n; n++)
              t[n] = arguments[n + 1];
