      ...
      if (i === 0) {
        ...
        $("#lead-story").append(
          '<div class="group"><a href="' +
            entry.link +
            '"><img class="lead-image" border="0" src="' +
            thumb +
            '" /></a><div class="lead-head"><a href="' +
            entry.link +
            '"> ' +
            entry.title +
            '</a></div><div class="story-date">' +
            date_string +
            '</div><div class="lead-lede">' +
            lede +
            "</div></div>"
        );
      } else {
        $("#reg-stories").append(
          '<div class="reg-story"><div class="group"><a href="' +
            entry.link +
            '"><img class="reg-image" border="0" src="' +
            thumb +
            '" /></a><div class="reg-head"><a href="' +
            entry.link +
            '"> ' +
            entry.title +
            '</a></div><div class="story-date">' +
            date_string +
            '</div><div class="reg-lede">' +
            lede +
            "</div></div></div>"
        );
      }
